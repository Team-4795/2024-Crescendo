 ...
 */
public class LoggedProfiledPIDController implements Sendable {
  private static int instances;

  private LoggedPIDController m_controller;
   ...
   */
  public LoggedProfiledPIDController(
  ...
  public LoggedProfiledPIDController(
    ...
    m_controller = new LoggedPIDController(Kp, Ki, Kd, period);
  ...
  public double getPVolts() {
    return m_controller.getPVolts();
  }

  public double getIVolts() {
    return m_controller.getIVolts();
  }

  public double getDVolts() {
    return m_controller.getDVolts();
  }
