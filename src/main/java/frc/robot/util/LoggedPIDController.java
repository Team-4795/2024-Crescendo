...
public class LoggedPIDController implements Sendable, AutoCloseable {
   ...
   */
  public LoggedPIDController(double kp, double ki, double kd) {
    this(kp, ki, kd, 0.02);
  }
  ...
  public LoggedPIDController(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
  ...
  public double getIVolts() {
    return m_ki * m_totalError;
  }

  public double getDVolts() {
    return m_kd * m_velocityError;
  }
